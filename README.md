...
Complete database with comprehensive reviews for 201 local multiplayer games supporting many players (8+ simultaneous players).
...
Complete review data for 201 games in `/reviews/` directory, including:
...
- Plus 185 additional games covering diverse multiplayer genres

See the **[Interactive Visualizer](https://cschubiner.github.io/gamelist_manyplayers/)** for the complete, sortable list of all 201 games.
...
```
gamelist-reviews/
├── reviews/              # 201 markdown review files
├── data/                 # 201 JSON files with structured game data
├── docs/
